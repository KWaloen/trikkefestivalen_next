          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td data-label="Konserten starter hvor">Bergens Tekniske Museum</td>
                <td data-label="Konserten starter når">13:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">SPARKESYKKEL</td>
                <td data-label="Konserten starter hvor">Engen, foran DNS</td>
                <td data-label="Konserten starter når">14:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">EMBLA</td>
                <td data-label="Konserten starter hvor">Bergens Tekniske Museum</td>
                <td data-label="Konserten starter når">15:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">SKANKY</td>
                <td data-label="Konserten starter hvor">Engen, foran DNS</td>
                <td data-label="Konserten starter når">16:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">BEINGAMONKEY</td>
                <td data-label="Konserten starter hvor">Bergens Tekniske Museum</td>
                <td data-label="Konserten starter når">17:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">JULIE GREVE</td>
                <td data-label="Konserten starter hvor">Engen, foran DNS</td>
                <td data-label="Konserten starter når">18:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">RAA DUO</td>
                <td data-label="Konserten starter hvor">Café Opera</td>
                <td data-label="Konserten starter når">19:00</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">KATHY LONG</td>
                <td data-label="Konserten starter hvor">Café Opera</td>
                <td data-label="Konserten starter når">19:30</td>
              </tr>
              <tr>
                <td data-label="Artistnavn">HIN</td>
                <td data-label="Konserten starter hvor">Café Opera</td>
                <td data-label="Konserten starter når">20:00</td>
              </tr>
            </tbody>
          </table>
        </div>
