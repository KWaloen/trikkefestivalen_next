                ...
                <div className={styles.questionGrid}>
                    ...
                    <details className={styles.ofte_stilte_spmItem}>
                        ...
                        <div className={styles.answer}>
                            I 2025 arrangerer vi for første gang Trikkefestivalen, en lokal musikkfestival hvor vi kombinerer den historiske trikken med moderne musikk!
                            ...
                            <br />
                            <br />
                            Festivalen drives med støtte fra Sparebanken Norge. Vi har også partnerskap med <a href="https://besporvei.net/">Bergen Elektriske Sporvei</a>.
                        </div>
                    </details>
